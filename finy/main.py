...
#     """
#     tg_msg = {"chat_id": config.telegram_config.chet_id, "text": message, "parse_mode": "Markdown"}
#     API_URL = f"https://api.telegram.org/bot{config.telegram_config.bot_token}/sendMessage"
